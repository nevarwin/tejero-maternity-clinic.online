        ...
        get_new_born() {
            ...
            for (let i = 0; i < this.case_NewBorn.length; i++) {
                ...
                new_born_info.push(
                    ...
                    {
                        question:
                            "Head, neck(molding,caput,craniolabels,cephalometoma)",
                    ...
                    { question: "Lungs", answer: element.lungs },
                    { question: "Heart", answer: element.heart },
                    {
                    ...
                    {
                        question:
                            "Extremities (including clavicles and abduction of hip joints)",
                        answer: element.extremities,
                    },
                    { question: "Anus", answer: element.anus },
                    {
