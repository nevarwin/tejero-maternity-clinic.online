<template>
    <v-container class="container-main pt-0 pl-0" fluid>
        <v-card
            style="padding: 10px"
            flat
            class="abstruct_fontSize"
            id="printMedicalAbstruct"
        >
            <v-row>
                <!-- {{case_data}} -->
                <v-col xs="12" md="6">
                    Name of Patient: {{ case_data.patient_name }}
                </v-col>
                <v-col xs="12" md="6"> Date: 2024/01/08 </v-col>
            </v-row>
            <v-row>
                <v-col xs="12" md="6">
                    Date Admitted: {{ case_data.admission_date }}</v-col
                >
                <v-col xs="12" md="6"> Date Discharged: 2024/01/08 </v-col>
            </v-row>
            <v-row>
                <v-col cols="12">
                    Admitting Diagnosis: test admitting diagnosis</v-col
                >
            </v-row>
            <br />
            ...
            <v-row>
                ...
                <v-col xs="12" md="6">
                    <v-row>
                        <v-col>LMP:{{ case_data.lmp }}</v-col></v-row
                    >
                    <v-row>
                        <v-col>EDC:{{ case_data.edc }}</v-col></v-row
                    >
                    <v-row>
                        <v-col>AOG:{{ case_data.aog }}</v-col></v-row
                    >
                </v-col>
            </v-row>
            ...
            <v-row>
                <v-col xs="12" sm="6" md="4"
                    >Temp: {{ case_data.temperature }}</v-col
                >
                <v-col xs="12" sm="6" md="4"
                    >Cardiac Rate: {{ case_data.pulse_rate }}</v-col
                >
                <v-col xs="12" sm="6" md="4"
                    >Respiratory Rate: {{ case_data.respiratory_rate }}</v-col
                >
            </v-row>
            <v-row>
                <v-col xs="12" sm="6" md="4"
                    >Weight: {{ case_data.weight }}</v-col
                >
                <v-col xs="12" sm="6" md="4"
                    >B.P: {{ case_data.blood_presure }}</v-col
                >
                <v-col></v-col>
            </v-row>
